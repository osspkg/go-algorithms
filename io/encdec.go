...
func AddFileEncoder(ext string, enc func(v interface{}) ([]byte, error), dec func([]byte, interface{}) error) {
	_default.Add(ext, enc, dec)
}

func (v *encoders) Add(ext string, enc func(v interface{}) ([]byte, error), dec func([]byte, interface{}) error) *encoders {
	v.mux.Lock(func() {
		v.enc[ext] = enc
		v.dec[ext] = dec
	})
